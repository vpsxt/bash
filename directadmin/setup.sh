	...
	if [ "$B64" -eq 1 ]; then
		case "$OS_VER" in
			...
			6.0|6.1|6) SERVICES=services_debian60_64.tar.gz
				;;
			7.0|7.1|7) SERVICES=services_debian70_64.tar.gz
				;;
		...
		case "$OS_VER" in
			...
			6|6.0|6.1) SERVICES=services_debian60.tar.gz
				;;
			7|7.0|7.1) SERVICES=services_debian70.tar.gz
				;;
...
if [ $PERL -eq 0 ]; then
	case "$OS_VER" in
		5.3|5.4|5.5|5.6|5.7|5.8|5.9|6.0|6.1|6.2|6.3|6.4|6.5|7|7.0|7.1|7.2|7.3|7.4|7.5|8|8.0|8.1|8.2|8.3|8.4|8.5)	addPackage perl "$perl";
			;;
